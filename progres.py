...
st.session_state.database_workers.pop(f"{area_pilih}_{pek_hapus}tukang", None)
st.session_state.database_workers.pop(f"{area_pilih}{pek_hapus}_peladen", None)
simpan_database()
...
nama_tukang = st.session_state.database_workers.get(f"{area}_{pekerjaan}tukang", "-")
nama_peladen = st.session_state.database_workers.get(f"{area}{pekerjaan}_peladen", "-")
...
prefix = f"{area}{pekerjaan}".replace(" ", "_")
foto_ditemukan = None
...
kunci_tukang = f"{area_terpilih}_{main_task}tukang"
kunci_peladen = f"{area_terpilih}{main_task}_peladen"
...
unik_key = f"sld_{area_terpilih}{main_task}{printilan}"
...
nama_file = f"{area_terpilih}{main_task}{foto_file.name}".replace(" ", "_")
